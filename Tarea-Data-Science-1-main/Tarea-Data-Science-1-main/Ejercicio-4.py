# Que porcentaje de estudiantes tiene al menos una nota najo 4.0
...
for nota in Notas_totales:
    if nota < 4.0 and Notas_bajo_4 < Total_de_estudiantes:
        Notas_bajo_4 += 1

porcentaje = (Notas_bajo_4 / Total_de_estudiantes) * 100

print(f"El porcentaje de estudiantes con al menos una nota bajo 4.0 es: {porcentaje:.2f}%")